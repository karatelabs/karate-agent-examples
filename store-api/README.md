...
**Or the plain JAR** (Java 21+) — download `karate-agent-2.1.2.RC3.jar` from
<https://github.com/karatelabs/karate-addons/releases> (release tag `agent-2.1.2.RC3`), then from
this folder:

```bash
java -jar karate-agent-2.1.2.RC3.jar serve
```
