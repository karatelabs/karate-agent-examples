...
| file | what it is |
| --- | --- |
| `karate-async-2.1.3.RC3.jar` | the engine |
...
java -jar karate-async-2.1.3.RC3.jar serve . --port 4444
```
...
java -jar karate-async-2.1.3.RC3.jar launch contract.karate.js
...
KARATE_KAFKA_ON=1 java -jar karate-async-2.1.3.RC3.jar serve . --port 4444
...
KARATE_GRPC_ON=1 KARATE_KAFKA_ON=1 \
  java -jar karate-async-2.1.3.RC3.jar launch suite.karate.js
